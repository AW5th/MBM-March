...
import 'package:MusicByMasses/fig2flutterapp/Profile_Page/generated/GeneratedIcon1024x1024FullWidget9.dart';
import 'package:MusicByMasses/fig2flutterapp/Profile_Page/generated/GeneratedEllipse3Widget1.dart';
...
class GeneratedGroup1526Widget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () =>
          Navigator.push(context, PageTransition(type: PageTransitionType.fade, duration: Duration(milliseconds: 100), child: View_Song_MBM_Selected())),
      child: Container(
        width: 75.0,
        height: 75.0,
        child: Stack(
